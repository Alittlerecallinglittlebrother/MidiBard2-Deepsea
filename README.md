...
当前版本 **3.2.5.15**，Dalamud API 15，Windows x64 / .NET 10。作者署名：akira0245, Ori, Kalle, Zune, 断水剑。
...
原 MidiBard 主窗口底部和自动点歌窗口右上方新增“联系作者”，点击使用系统默认浏览器打开 [深海网站](https://shenhai.meoo.zone/)。保留 3.2.5.14 的载入超时修复、队员回执及队长自动接管。

本次独立仓库首发更新安装元数据和文档，演奏代码与已交付的本地 3.2.5.15 一致。已通过本地编译和原生 ImGui 检查；真实游戏中的多电脑合奏及樱花公网接管仍待验收。详见 [验证记录](STAGE-VERIFICATION.md)。
