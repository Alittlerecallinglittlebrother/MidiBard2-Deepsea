...
public partial class MidiBard : IDalamudPlugin
{
    ...
    public unsafe MidiBard(IDalamudPluginInterface pi)
    {
        ...
        Ui = new PluginUI();
        Stage = new StageIntegration.StageFeature();
    ...
    private void OnFrameworkUpdate(IFramework framework)
    {
        ...
        if (AgentPerformance.InPerformanceMode && !PlaylistManager.IsLoading && PlaylistManager.LastLoadSucceeded && !SwitchInstrument.SwitchingInstrument)
        {
