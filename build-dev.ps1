param(
    [string]$Destination = (Join-Path $env:APPDATA 'XIVLauncherCN/devPlugins/MidiBard2-Deepsea-v0.12'),
...
foreach ($name in @('LICENSE', 'LIVE-INSTRUMENT-SWITCH.md', 'STAGE-README.md', 'STAGE-ROOM.md', 'STAGE-IPC.md', 'STAGE-VERIFICATION.md')) {
